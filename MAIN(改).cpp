...
//===================================================================================
        int kk[6][3] = {{400,100,-3}, {600,100,-3}, {600,250,-3}, {  0, 30,-3}, {300,150,-3}, {800,250,-3}};
        for(int i = 0 ; i < 6 ; i++ ) Ubike2_0[i] = kk[i];
        op.play();
...
//===============================================================================================================================
        while( !quit ){
            if( timer.getTicks() != 0 )
            {
                ...
                int playstatus[6][3] = {{-1000,185,-3},{1200,190,-3},{1000,235,-3},{-100, 240,-3},{-1700,285,-3},{1400,290,-3}};
                for(int i = 0 ; i < 6 ; i++ ) Ubike2_0[i] = playstatus[i];
            }
            while(  timer.getTicks() > 0  && !death )
            {
                ...
                case 0:
                Ubike2_0[0].mVelX = -5;if(timer.getTicks()%21000 == 0) --Ubike2_0[0];
                Ubike2_0[1].mVelX = -1;if(timer.getTicks()% 9900 == 0) --Ubike2_0[1];
                Ubike2_0[2].mVelX = -6;if(timer.getTicks()% 6000 == 0) --Ubike2_0[2];
                Ubike2_0[3].mVelX = -4;if(timer.getTicks()%10000 == 0) --Ubike2_0[3];
                Ubike2_0[4].mVelX = -3;if(timer.getTicks()% 6200 == 0) --Ubike2_0[4];
                Ubike2_0[5].mVelX = -7;if(timer.getTicks()% 4100 == 0) --Ubike2_0[5];break;
                case 1:
                Ubike2_0[0].mVelX = -3;if(timer.getTicks()% 6200 == 0)--Ubike2_0[0];
                Ubike2_0[1].mVelX = -4;if(timer.getTicks()% 20000== 0)--Ubike2_0[1];
                Ubike2_0[2].mVelX = -5;if(timer.getTicks()% 11000== 0)--Ubike2_0[2];
                Ubike2_0[3].mVelX = -1;if(timer.getTicks()% 9900== 0)--Ubike2_0[3];
                Ubike2_0[4].mVelX = -6;if(timer.getTicks()% 6000== 0)--Ubike2_0[4];
                Ubike2_0[5].mVelX = -7;if(timer.getTicks()% 4100== 0)--Ubike2_0[5];break;
                case 2:
                Ubike2_0[0].mVelX = -5;if(timer.getTicks()% 11000 == 0)--Ubike2_0[0];
                Ubike2_0[1].mVelX = -4;if(timer.getTicks()% 20000 == 0)--Ubike2_0[1];
                Ubike2_0[2].mVelX = -5;if(timer.getTicks()% 11000 == 0)--Ubike2_0[2];
                Ubike2_0[3].mVelX = -1;if(timer.getTicks()% 16000 == 0)--Ubike2_0[3];
                Ubike2_0[4].mVelX = -3;if(timer.getTicks()% 6200 == 0)--Ubike2_0[4];
                Ubike2_0[5].mVelX = -7;if(timer.getTicks()% 4100 == 0)--Ubike2_0[5];break;
                }
                //Render objects
